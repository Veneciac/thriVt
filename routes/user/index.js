...
var oauth = new OAuth.OAuth(
    ...
    process.env.consumerKey, //consumer key
    process.env.consumerSecret, //secret
    '1.0A',
    null,
    'HMAC-SHA1'
  );
...
route.get('/tweet/post/:twit', cekLogin, cekUser, (req, res) => {
    oauth.post(
        // prcess.env.consumerKey
    'https://api.twitter.com/1.1/statuses/update.json' , 
        process.env.userToken, //user token
        process.env.userSecret, //user secret
        { status: `thriVt :
